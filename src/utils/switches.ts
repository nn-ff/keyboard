...
export const switchDescriptionArr = [
  ...
  },
  {
    ...
    descProperty:
      '<p>Производитель: Cherry<br>Тип: кликающий<br>Сила нажатия: 60 грамм (несмотря на вес, средние)<br>Длина пути: 4 мм (2.2 мм до срабатывания)</p>',
    title: 'Cherry MX Blue',
    img: 'https://static.insales-cdn.com/files/1/3081/17206281/original/img-productstage-mxBlueRGB_2x-368x368_result.webp',
  },
  {
    id: 9,
    shortTitle: 'BR',
    ...
    descProperty:
      '<p>Производитель: Cherry<br>Тип: тактильный&nbsp;<br>Сила нажатия: 55 грамм (средние)<br>Длина пути: 4 мм (2 мм до срабатывания)</p>',
    title: 'Cherry MX Brown',
    img: 'https://static.insales-cdn.com/files/1/2117/17205317/original/img-productstage-mxBrownRGB_2x_100-368x3681111_257241d175bfeef1fcc813db00c125d6_result.webp',
  },
  {
    id: 10,
    shortTitle: 'R',
    ...
    descProperty:
      '<p>Производитель: Cherry<br>Тип: линейный<br>Сила нажатия: 45 грамм (лёгкие)<br>Длина пути: 4 мм (2 мм до срабатывания)</p>',
    title: 'Cherry MX Red',
    img: 'https://static.insales-cdn.com/files/1/3080/17206280/original/img-productstage-mxRedRGB_2x_100-368x3681111_8cbb53a369430863c70bd9260defe578_result.webp',
  },
  {
    id: 11,
    shortTitle: 'SR',
    ...
    descProperty:
      '<p>Производитель: Cherry<br>Тип: тихий линейный<br>Сила нажатия: 45 грамм (легкие)<br>Длина пути: 3.7 мм (1.9 мм до срабатывания)</p>',
    title: 'Cherry MX Silent Red',
    img: 'https://static.insales-cdn.com/files/1/3105/17206305/original/img-productstage-mxRedSilentRGB_2x-368x368_result.webp',
  },
  {
    id: 12,
    shortTitle: 'SS',
